            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <x-nav-link href="/dashboard/blog" :active="request()->is('dashboard/blog')">Blog</x-nav-link>
                        {{-- hanya dilihat oleh admin, gunakan gate pada providers/AppServiceProviders --}}
                    ...
                    <div class="relative ml-3">
                        ...
                        <div x-show="isOpen" x-transition:enter="transition ease-out duration-100 transform"
                            ...
                            <form action="/logout" method="post">
                                @csrf
                                <button type="submit" class="block px-4 py-2 text-sm text-gray-700">Log
                                    Out</button>
                            </form>
                        </div>
                    </div>
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
        ...
        <div class="border-t border-gray-700 pb-3 pt-4">
            <div class="flex items-center px-5">
                ...
                <div class="ml-3">
                    <div class="text-base font-medium leading-none text-white">Welcome back,
                        {{ auth()->user()->name }}
                    </div>
